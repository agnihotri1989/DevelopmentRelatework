...
<div align="center">
  ...
  <a href="DEMO_VIDEO_LINK_HERE">
    <img src="TaskMatrix_ReactApp/assets/taskmatrix_preview.png" alt="TaskMatrix Demo Walkthrough" width="85%" style="border-radius: 12px; box-shadow: 0 8px 24px rgba(0,0,0,0.25);" />
  </a>
...
```
TaskMatrix/
├── PLAN.md                  # Comprehensive architectural spec & Lego learning roadmap
├── Skills.md                # Agent skill execution blueprint
└── TaskMatrix_ReactApp/     # Expo application codebase
    ...
    ├── src/
    │   ├── components/      # Pure, reusable UI components (TodoInput, TodoItem, StatCard)
    │   ├── hooks/           # Custom state & analytics hooks (useTodos, useAnalytics)
    │   ├── navigator/       # Navigation configuration (AppNavigator with bottom tabs)
    │   ├── screens/         # Top-level screen views (HomeScreen, AnalyticsScreen)
    │   ├── storage/         # AsyncStorage persistence wrapper
    │   └── utils/           # Constants (COLORS, CATEGORIES) & shadows engine
    └── LICENSE              # MIT License
```
...
## 📄 License
This project is open-source and licensed under the [MIT License](TaskMatrix_ReactApp/LICENSE).
